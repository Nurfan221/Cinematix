    ...
    <div class="w-full h-[110vh] pt-32">
        ...
        <div>
            ...
            <div class="flex justify-center w-full my-5">
                <input type="submit" onclick="kirim_data()" id="submitButton" class="w-[70%] py-4 mx-auto border border-slate-600" value="Beli">
            </div>
...
<script>
    function kirim_data() {
        ...
        // Mengambil data dari checkbox yang dipilih
        var selectedkursi = [];
        $('input[type="checkbox"]:checked').each(function() {
            selectedkursi.push($(this).val());
        });
        const id_film = document.getElementById("id_film").value;
        ...
        $.ajax({
            url: 'http://localhost/in_cinema/insert_tiket.php',
            method: 'POST',
            data: {
                id_film: id_film,
